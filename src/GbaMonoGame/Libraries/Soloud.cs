// NOTE: This file comes from the SoLoud downloads, but has been modified with various fixes
...
public abstract class SoloudObject : IDisposable
{
...
public class Soloud : SoloudObject
{
    ...
    {
        return Soloud_playEx(objhandle, aSound.objhandle, aVolume, aPan, aPaused ? 1 : 0, aBus);
    }
    ...
    {
        return Soloud_getPause(objhandle, aVoiceHandle) != 0;
    }
    ...
    {
        return Soloud_isValidVoiceHandle(objhandle, aVoiceHandle) != 0;
    }
    ...
    {
        Soloud_setLooping(objhandle, aVoiceHandle, aLooping ? 1 : 0);
    }
    ...
    {
        Soloud_setPause(objhandle, aVoiceHandle, aPause ? 1 : 0);
    }
...
public class Wav : SoloudObject
{
    ...
    {
        Wav_setLooping(objhandle, aLoop ? 1 : 0);
    }
