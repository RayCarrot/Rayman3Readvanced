...
public class GbaSoundEventsManager : SoundEventsManager
{
    ...
    private void UpdateVolumeAndPan(SongInstance songInstance)
    {
        ...
        bool forceRollOffAndPan = Engine.Settings.Local.Sound.ForceSoundPanning && songInstance.ReadvancedObj != null && !songInstance.IsMusic;
        ...
        if (songInstance.SoundType == SoundType.Sfx)
            vol *= Engine.Settings.Local.Sound.SfxVolume;
        else if (songInstance.SoundType == SoundType.Music)
            vol *= Engine.Settings.Local.Sound.MusicVolume;
    ...
    public override void PauseAllSongs()
    {
        ...
        {
            if (Engine.Settings.Local.Sound.PlayMusicWhenPaused != true || playingSong.SoundType == SoundType.Sfx)
            {
