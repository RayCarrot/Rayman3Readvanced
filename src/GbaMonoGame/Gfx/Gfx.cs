...
public static class Gfx
{
    ...
    private static void DrawGameLayer(GfxRenderer renderer, int layer)
    {
        ...
        if (Rom.IsLoaded && (Rom.Platform == Platform.GBA || Engine.Settings.Active.Tweaks.UseGbaEffectsOnNGage) && _drawnSpriteLayers[layer])
        {
    ...
    {
        if ((!Rom.IsLoaded || Rom.Platform == Platform.GBA || Engine.Settings.Active.Tweaks.UseGbaEffectsOnNGage) && 
