...
public class ControlOptionsMenuOption : OptionsMenuOption
{
    ...
    {
        Keys prevKey = Engine.Settings.Local.Controls.KeyboardControls[Input];
        Engine.Settings.Local.Controls.KeyboardControls[Input] = key;
    ...
    {
        Buttons prevButton = Engine.Settings.Local.Controls.GamePadControls[Input];
        Engine.Settings.Local.Controls.GamePadControls[Input] = button;
