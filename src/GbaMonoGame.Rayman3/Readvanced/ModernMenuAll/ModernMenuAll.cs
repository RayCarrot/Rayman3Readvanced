...
public class ModernMenuAll : Frame, IHasPlayfield
{
    ...
    public void LoadGameInfo()
    {
        ...
        for (int i = 0; i < Slots.Length; i++)
        {
            if (Rayman3.Save.SlotExists(i))
            {
                ...
                Slots[i] = new Slot(Rayman3.GameInfo.GetTotalDeadLums(), Rayman3.GameInfo.GetTotalDeadCages(), Rayman3.GameInfo.PersistentInfo.Lives, Rayman3.GameInfo.GetPlayTime());
    ...
    public override void Init()
    {
        ...
        Texture2D curtainTexture = Engine.Assets.FrameContentManager.Load<Texture2D>(Assets.Menu.MenuCurtain);
        ...
        Texture2D woodenFrameTexture = Engine.Assets.FrameContentManager.Load<Texture2D>(Assets.Menu.MenuWoodenFrame);
