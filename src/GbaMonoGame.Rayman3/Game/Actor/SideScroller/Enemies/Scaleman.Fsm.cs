...
public partial class Scaleman
{
            ...
            case FsmAction.Step:
                ...
                if (IsActionFinished)
                {
                    if (ActionId is Action.Ball_Bounce_Right or Action.Ball_Bounce_Left)
                    {
                        ...
                        Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__ScalBong_PinBall_Mix02, this);
                    }
                    else if (ActionId is Action.Emerge_Right or Action.Emerge_Left)
                    {
                        Timer = 0;
    ...
    public bool Fsm_BallAirAttackFlyUp(FsmAction action)
    {
        switch (action)
        {
            case FsmAction.Init:
                ...
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__ScalUp_Mix03, this);
                break;
    ...
    public bool Fsm_BallAirAttackFlyDown(FsmAction action)
    {
        switch (action)
        {
            ...
            case FsmAction.Step:
                ...
                if (Engine.Settings.Active.Tweaks.FixBugs && ScalemanShadow.AnimatedObject.EndOfAnimation && ScalemanShadow.AnimatedObject.CurrentAnimation == 11)
                    ScalemanShadow.AnimatedObject.CurrentAnimation = 13;
    ...
    public bool Fsm_SmallRun(FsmAction action)
    {
        ...
        {
            case FsmAction.Init:
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__ScalFlee_Mix02, this);
            ...
            case FsmAction.Step:
                ...
                if (Timer >= 340)
                {
                    Engine.Sem.ProcessEvent(Rayman3SoundEvent.Stop__ScalFlee_Mix02, this);
                    ...
                    if (IsActionFinished)
                    {
                        ...
                        else if (ActionId is Action.Small_Hop_Right or Action.Small_Hop_Left)
                        {
                            ...
                            Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__ScaMorf2_Mix02, this);
                        }
    ...
    public bool Fsm_SmallHit(FsmAction action)
    {
        switch (action)
        {
            case FsmAction.Init:
                ...
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__ScaHurt2_Mix02, this);
                HitPoints--;
                HitTimer = 0;
                break;
                ...
                if (IsActionFinished)
                {
                    ...
                    else if (ActionId is Action.Grow_Right or Action.Grow_Left)
                    {
                        if (HitPoints == 3)
                        {
                            ...
                            Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__ScalGrrr_Mix02, this);
                        }
                        else if (HitPoints == 0)
                        {
