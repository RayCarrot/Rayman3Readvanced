...
public partial class Caterpillar
{
    ...
    public bool Fsm_Projectile(FsmAction action)
    {
        switch (action)
        {
            case FsmAction.Init:
                ...
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__MumuHit_SkullHit_Mix02, this);
                break;
    ...
    public bool Fsm_ProjectileReturn(FsmAction action)
    {
        switch (action)
        {
            case FsmAction.Init:
                ...
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__MumuWake_LumHit_Mix03, this);
                break;
    ...
    public bool Fsm_Dying(FsmAction action)
    {
        ...
        {
            case FsmAction.Init:
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__MumuDead_Mix04, this);
