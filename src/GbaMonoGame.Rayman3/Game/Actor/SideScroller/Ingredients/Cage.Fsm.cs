...
public partial class Cage
{
        ...
        switch (action)
        {
            case FsmAction.Init:
                ...
                if (!Scene.KeepAllObjectsActive || IsInCurrentKnot)
                    Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__CageSnd1_Mix02__or__CageSnd2_Mix02, this);
    ...
    public bool Fsm_Damaged(FsmAction action)
    {
        ...
        {
            case FsmAction.Init:
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__CageHit_Mix07, this);
