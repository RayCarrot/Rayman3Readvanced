    ...
    public bool Fsm_Break(FsmAction action)
    {
        switch (action)
        {
            case FsmAction.Init:
                ...
                Engine.Sem.ProcessEvent(Rayman3SoundEvent.Play__WoodBrk1_Mix04, this);
                break;
    ...
    public bool Fsm_WaitInWater(FsmAction action)
    {
        switch (action)
        {
            ...
            case FsmAction.Step:
                ...
                if (linkedMovement)
                {
                    State.MoveTo(_Fsm_MoveForwardInWater);
                    return false;
                }
                break;
    ...
    public bool Fsm_MoveForwardInWater(FsmAction action)
    {
        switch (action)
        {
            ...
            case FsmAction.Step:
                ...
                {
                    MoveRight = !MoveRight;
                    State.MoveTo(_Fsm_MoveBackwardsInWater);
                    return false;
                }
                break;
