...
public class FrameMultiSideScroller : Frame, IHasScene, IHasPlayfield
{
    ...
    public override void Init()
    {
        ...
        {
            AnimatedObjectResource resource = Rom.Loader.ReadResource<AnimatedObjectResource>(Rayman3DefinedResource.NGageMultiplayerPauseSignAnimations);
        ...
        PauseDialog = Engine.Settings.Active.Tweaks.UseModernPauseDialog ? new ModernPauseDialog(Scene, false) : new PauseDialog(Scene);
