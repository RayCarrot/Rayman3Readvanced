...
public class BossRockAndLavaBar : Bar
{
    ...
    {
        AnimatedObjectResource resource = Rom.Loader.ReadResource<AnimatedObjectResource>(Rayman3DefinedResource.BossRockAndLavaBarAnimations);
        ...
        if (Rayman3.TimeAttack.IsActive)
        {
            ...
            BossHealthBar.ScreenPos = BossHealthBar.ScreenPos with { Y = -12 };
        }
    }
