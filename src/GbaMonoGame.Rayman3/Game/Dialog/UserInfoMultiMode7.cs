...
public class UserInfoMultiMode7 : Dialog
{
    ...
    public override void Load()
    {
        ...
        AnimatedObjectResource mapsResource = Rom.Loader.ReadResource<AnimatedObjectResource>(Rayman3DefinedResource.MissileMapAnimations);
        AnimatedObjectResource hudResource = Rom.Loader.ReadResource<AnimatedObjectResource>(Rayman3DefinedResource.HudAnimations);
        ...
        AnimatedObjectResource ranksResource = Rom.Loader.ReadResource<AnimatedObjectResource>(Rayman3DefinedResource.MultiplayerRankAnimations);
